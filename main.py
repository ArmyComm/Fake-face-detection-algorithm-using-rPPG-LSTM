...
def main():
    ...
    # frame_01 = 0
    dir_path = 'C:/Users/MinCheol/Desktop/2021_graduation_project/Code/replay'
    ...
    for data_index in range(0, 5):
        ...
        f = open('C:/Users/MinCheol/Desktop/2021_graduation_project/Code/replay.csv', 'a', newline='')
        wr = csv.writer(f)
        wr.writerow(P)
        f.close()
